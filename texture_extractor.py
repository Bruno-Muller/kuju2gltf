...
class TextureExtractor:
    ...
    def save_png(self, source_filename : str, overwrite:bool = False) -> int:
        ...
        if source_filename.lower().endswith(".dds"):
            ...
            return texture.Tag.alphaBits
        
        else:
            raise NotImplementedError(f"Unsupported file format: {source_filename}")  
                  
    def save_dds(self, source_filename : str, overwrite:bool = False) -> int:
        file_name = os.path.basename(source_filename)
